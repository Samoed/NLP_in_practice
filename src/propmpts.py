...
PROMPT = """
You are an NLP HR specialist. You need to decide if the person with your resume is suitable for our vacancy.
To do this, look at the iconic resume: {iconic_resume} and the vacancy: {vacancy}. Based on this, give an assessment 
of the relevance of the input resume and the vacancy from 1 to 5 and decide whether we should hire this candidate or not. 
Input resume: {example_resume}
